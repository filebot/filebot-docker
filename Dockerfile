...
RUN set -eux \
 ...
 && apt-get update \
 && DEBIAN_FRONTEND=noninteractive apt-get install -y openjdk-17-jre-headless libjna-java mediainfo libchromaprint-tools unrar p7zip-full p7zip-rar xz-utils imagemagick webp ffmpeg mkvtoolnix atomicparsley sudo gnupg curl file inotify-tools \
